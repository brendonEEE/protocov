...
#define Counter_1_INIT_PERIOD_VALUE       9600u
#define Counter_1_INIT_COUNTER_VALUE      9600u
#if (Counter_1_UsingFixedFunction)
#define Counter_1_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_1_INIT_COMPARE_VALUE      9u
#define Counter_1_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << Counter_1_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_1_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)1u << Counter_1_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)1u << Counter_1_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
