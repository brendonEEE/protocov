// ======================================================================
// Protocov.v generated from TopDesign.cysch
// 10/28/2023 at 14:44
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=11, BreakBitsTX=11, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=false, InternalClock=true, InternalClockToleranceMinus=4.59526315789474, InternalClockTolerancePlus=4.59526315789474, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=16, ParityType=0, ParityTypeSw=false, RequiredClock=153600, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=BluetoothUART, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BluetoothUART, CY_INSTANCE_SHORT_NAME=BluetoothUART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=BluetoothUART, )
module UART_v2_50_1 (
    clock,
    cts_n,
    reset,
...
module USBFS_v3_20_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("cd07f62c-3f08-4b86-a5cb-8ccc45312a33/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=9, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=9600, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=9600, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Counter_1, )
...
// ADC_SAR_v3_10(ADC_Clock=0, ADC_Clock_Frequency=1292736, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=4, Sample_Rate=80796, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=VehicleBattVoltageAdc, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VehicleBattVoltageAdc, CY_INSTANCE_SHORT_NAME=VehicleBattVoltageAdc, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VehicleBattVoltageAdc, )
...
module top ;
	...
	wire [0:0] tmpOE__PlayPauseButton_net;
	wire [0:0] tmpFB_0__PlayPauseButton_net;
	wire [0:0] tmpIO_0__PlayPauseButton_net;
	wire [0:0] tmpINTERRUPT_0__PlayPauseButton_net;
	electrical [0:0] tmpSIOVREF__PlayPauseButton_net;

	cy_psoc3_pins_v1_10
		#(.id("54fcb113-3f9f-4838-9fc7-79deb44580f6"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PlayPauseButton
		 (.oe(tmpOE__PlayPauseButton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PlayPauseButton_net[0:0]}),
		  .io({tmpIO_0__PlayPauseButton_net[0:0]}),
		  .siovref(tmpSIOVREF__PlayPauseButton_net),
		  .interrupt({tmpINTERRUPT_0__PlayPauseButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PlayPauseButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NextButton_net;
	wire [0:0] tmpFB_0__NextButton_net;
	wire [0:0] tmpIO_0__NextButton_net;
	wire [0:0] tmpINTERRUPT_0__NextButton_net;
	electrical [0:0] tmpSIOVREF__NextButton_net;

	cy_psoc3_pins_v1_10
		#(.id("b4809fc7-edda-4619-9524-f9f1c7a2bb6e"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NextButton
		 (.oe(tmpOE__NextButton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NextButton_net[0:0]}),
		  .io({tmpIO_0__NextButton_net[0:0]}),
		  .siovref(tmpSIOVREF__NextButton_net),
		  .interrupt({tmpINTERRUPT_0__NextButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NextButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PreviousButton_net;
	wire [0:0] tmpFB_0__PreviousButton_net;
	wire [0:0] tmpIO_0__PreviousButton_net;
	wire [0:0] tmpINTERRUPT_0__PreviousButton_net;
	electrical [0:0] tmpSIOVREF__PreviousButton_net;

	cy_psoc3_pins_v1_10
		#(.id("a528adc0-31c1-4dcd-a33f-b1fcad87400b"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PreviousButton
		 (.oe(tmpOE__PreviousButton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PreviousButton_net[0:0]}),
		  .io({tmpIO_0__PreviousButton_net[0:0]}),
		  .siovref(tmpSIOVREF__PreviousButton_net),
		  .interrupt({tmpINTERRUPT_0__PreviousButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PreviousButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PowerEnableSelf_net;
	wire [0:0] tmpFB_0__PowerEnableSelf_net;
	wire [0:0] tmpIO_0__PowerEnableSelf_net;
	wire [0:0] tmpINTERRUPT_0__PowerEnableSelf_net;
	electrical [0:0] tmpSIOVREF__PowerEnableSelf_net;

	cy_psoc3_pins_v1_10
		#(.id("10d3e4fa-c2e5-4df5-87bd-e55d4d573a8f"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PowerEnableSelf
		 (.oe(tmpOE__PowerEnableSelf_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PowerEnableSelf_net[0:0]}),
		  .io({tmpIO_0__PowerEnableSelf_net[0:0]}),
		  .siovref(tmpSIOVREF__PowerEnableSelf_net),
		  .interrupt({tmpINTERRUPT_0__PowerEnableSelf_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PowerEnableSelf_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PowerEnableBatt_net;
	wire [0:0] tmpFB_0__PowerEnableBatt_net;
	wire [0:0] tmpIO_0__PowerEnableBatt_net;
	wire [0:0] tmpINTERRUPT_0__PowerEnableBatt_net;
	electrical [0:0] tmpSIOVREF__PowerEnableBatt_net;

	cy_psoc3_pins_v1_10
		#(.id("a77db81b-feaf-4251-8d55-5980ac6db7bd"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PowerEnableBatt
		 (.oe(tmpOE__PowerEnableBatt_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PowerEnableBatt_net[0:0]}),
		  .io({tmpIO_0__PowerEnableBatt_net[0:0]}),
		  .siovref(tmpSIOVREF__PowerEnableBatt_net),
		  .interrupt({tmpINTERRUPT_0__PowerEnableBatt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PowerEnableBatt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PowerEnableACC_net;
	wire [0:0] tmpFB_0__PowerEnableACC_net;
	wire [0:0] tmpIO_0__PowerEnableACC_net;
	wire [0:0] tmpINTERRUPT_0__PowerEnableACC_net;
	electrical [0:0] tmpSIOVREF__PowerEnableACC_net;

	cy_psoc3_pins_v1_10
		#(.id("1676c86e-796d-4830-8be5-09ae959e3e8c"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PowerEnableACC
		 (.oe(tmpOE__PowerEnableACC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PowerEnableACC_net[0:0]}),
		  .io({tmpIO_0__PowerEnableACC_net[0:0]}),
		  .siovref(tmpSIOVREF__PowerEnableACC_net),
		  .interrupt({tmpINTERRUPT_0__PowerEnableACC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PowerEnableACC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VehicleCarBattVoltage_net;
	wire [0:0] tmpFB_0__VehicleCarBattVoltage_net;
	wire [0:0] tmpIO_0__VehicleCarBattVoltage_net;
	wire [0:0] tmpINTERRUPT_0__VehicleCarBattVoltage_net;
	electrical [0:0] tmpSIOVREF__VehicleCarBattVoltage_net;
	...
	cy_psoc3_pins_v1_10
		...
		VehicleCarBattVoltage
		 (.oe(tmpOE__VehicleCarBattVoltage_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VehicleCarBattVoltage_net[0:0]}),
		  .analog({Net_623}),
		  .io({tmpIO_0__VehicleCarBattVoltage_net[0:0]}),
		  .siovref(tmpSIOVREF__VehicleCarBattVoltage_net),
		  .interrupt({tmpINTERRUPT_0__VehicleCarBattVoltage_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VehicleCarBattVoltage_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CAN_v3_0_0 VehicleCAN (
        .interrupt(Net_261),
        .rx(Net_11),
        .tx(Net_12),
        .tx_en(Net_262));

	wire [0:0] tmpOE__CanTx_net;
	wire [0:0] tmpFB_0__CanTx_net;
	wire [0:0] tmpIO_0__CanTx_net;
	wire [0:0] tmpINTERRUPT_0__CanTx_net;
	electrical [0:0] tmpSIOVREF__CanTx_net;
	...
	cy_psoc3_pins_v1_10
		...
		CanTx
		 (.oe(tmpOE__CanTx_net),
		  .y({Net_12}),
		  .fb({tmpFB_0__CanTx_net[0:0]}),
		  .io({tmpIO_0__CanTx_net[0:0]}),
		  .siovref(tmpSIOVREF__CanTx_net),
		  .interrupt({tmpINTERRUPT_0__CanTx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CanTx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CanRx_net;
	wire [0:0] tmpIO_0__CanRx_net;
	wire [0:0] tmpINTERRUPT_0__CanRx_net;
	electrical [0:0] tmpSIOVREF__CanRx_net;
	...
	cy_psoc3_pins_v1_10
		...
		CanRx
		 (.oe(tmpOE__CanRx_net),
		  .y({1'b0}),
		  .fb({Net_11}),
		  .io({tmpIO_0__CanRx_net[0:0]}),
		  .siovref(tmpSIOVREF__CanRx_net),
		  .interrupt({tmpINTERRUPT_0__CanRx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CanRx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_1 BluetoothUART (
        .clock(1'b0),
        .cts_n(1'b0),
        .reset(1'b0),
        .rts_n(Net_68),
        ...
        .rx_clk(Net_70),
        .rx_data(Net_71),
        .rx_interrupt(Net_252),
        .tx(Net_73),
        .tx_clk(Net_74),
        .tx_data(Net_75),
        .tx_en(Net_76),
        .tx_interrupt(Net_89));
    defparam BluetoothUART.Address1 = 0;
    defparam BluetoothUART.Address2 = 0;
    defparam BluetoothUART.EnIntRXInterrupt = 0;
    defparam BluetoothUART.EnIntTXInterrupt = 0;
    defparam BluetoothUART.FlowControl = 0;
    defparam BluetoothUART.HalfDuplexEn = 0;
    defparam BluetoothUART.HwTXEnSignal = 0;
    defparam BluetoothUART.NumDataBits = 8;
    defparam BluetoothUART.NumStopBits = 1;
    defparam BluetoothUART.ParityType = 0;
    defparam BluetoothUART.RXEnable = 1;
    defparam BluetoothUART.TXEnable = 1;

	wire [0:0] tmpOE__UartTx_net;
	wire [0:0] tmpIO_0__UartTx_net;
	wire [0:0] tmpINTERRUPT_0__UartTx_net;
	electrical [0:0] tmpSIOVREF__UartTx_net;

	cy_psoc3_pins_v1_10
		#(.id("2f4aee2f-5e5e-43c4-96d1-2bf83c7dda3f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UartTx
		 (.oe(tmpOE__UartTx_net),
		  .y({1'b0}),
		  .fb({Net_189}),
		  .io({tmpIO_0__UartTx_net[0:0]}),
		  .siovref(tmpSIOVREF__UartTx_net),
		  .interrupt({tmpINTERRUPT_0__UartTx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UartTx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UartRx_net;
	wire [0:0] tmpFB_0__UartRx_net;
	wire [0:0] tmpIO_0__UartRx_net;
	wire [0:0] tmpINTERRUPT_0__UartRx_net;
	electrical [0:0] tmpSIOVREF__UartRx_net;

	cy_psoc3_pins_v1_10
		#(.id("c3c401c6-a8b7-4955-a80e-888718e99afa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UartRx
		 (.oe(tmpOE__UartRx_net),
		  .y({Net_73}),
		  .fb({tmpFB_0__UartRx_net[0:0]}),
		  .io({tmpIO_0__UartRx_net[0:0]}),
		  .siovref(tmpSIOVREF__UartRx_net),
		  .interrupt({tmpINTERRUPT_0__UartRx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UartRx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    USBFS_v3_20_2 ProtocovUSB (
        .sof(Net_263),
        .vbusdet(1'b0));
    defparam ProtocovUSB.epDMAautoOptimization = 0;
	...
	cy_clock_v1_0
		#(.id("27efdd42-d602-43d3-ac3e-b689218ee6e0"),
    ...
    assign Net_254 = ~Net_189;


	cy_clock_v1_0
		#(.id("473ad777-9569-4abf-9936-434704a24e14"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    assign Net_250 = Net_191 | Net_252;

    ADC_SAR_v3_10_4 VehicleBattVoltageAdc (
        .aclk(Net_322),
        .eoc(Net_323),
        .eos(Net_271),
        .soc(1'b0),
	...
	cy_clock_v1_0
		#(.id("a037405e-23e1-491b-b66b-c5ef8827b1e8"),
		  .source_clock_id(""),
		  .divisor(0),
